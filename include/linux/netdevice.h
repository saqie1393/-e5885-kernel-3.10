...
struct net_device_cbs_ops {
	int (*ndo_cbs_config_bw)(struct net_device *dev, int action, unsigned int bw, unsigned int class_id);
	int (*ndo_cbs_get_bw)(struct net_device *ndev, unsigned int class_id);
	int (*ndo_cbs_get_locredit)(struct net_device *dev,unsigned int class_id, int *locredit);
	int (*ndo_cbs_get_hicredit)(struct net_device *dev,unsigned int class_id,int *hicredit);
	int (*ndo_cbs_get_avb_algorithm)(struct net_device *dev,unsigned int class_id,int *sch);
	int (*ndo_cbs_get_preamble_ipg)(struct net_device *dev,unsigned int *igb_pre);
	int (*ndo_cbs_set_class_pcp)(struct net_device *ndev,unsigned int class_id, unsigned int pcp);
	int (*ndo_cbs_get_class_pcp)(struct net_device *ndev,unsigned int class_id, unsigned int *pcp);
};
#endif
...
#ifdef CONFIG_AVB_NET
	const struct net_device_cbs_ops *netdev_cbs_ops;
#endif
...
{
	return NAPI_GRO_CB(skb)->data_offset;/* [false alarm]:native code */
}
