...
{
	return wait_for_common(x, timeout, TASK_UNINTERRUPTIBLE);/* [false alarm]:native code */
}
...
{
	return wait_for_common_io(x, timeout, TASK_UNINTERRUPTIBLE);/* [false alarm]:native code */
}
...
{
	return sched_group_rt_period(cgroup_tg(cgrp));/* [false alarm]:native code */
}
#endif /* CONFIG_RT_GROUP_SCHED */
