...
/*20140926 modify by zhangtian 删除无用函数 如下:
get_snc_state_dlc
cmux_queue_dlc_data
cmux_set_tgt_dlc_state
cmux_get_tgt_dlc_state         */
...
void delete_head_cmd (struct cmuxlib *cm, unsigned char dlc)
{
    ...
    if (cm != NULL)
    {
        ...
        if (cmd_node != NULL)
        {
            ...
            if (cmd_node->fr != NULL)
            {
                /*<j80025223><m2m-1004><flow control buffering><Begin>*/
                // update statistics..
                ...
                /*<j80025223><m2m-1004><flow control buffering><End>*/
...
/*<j80025223><m2m-998><snc default db defining><Begin>*/
...
/*<j80025223><m2m-998><snc default db defining><End>*/
...
int cmux_TE_UE_rxed_DM (void *cmxlib, void *frm, unsigned char dlc)
{
    ...
    /*<j80025223><><DM response on snc for dlc greater than max number ><Begin>*/
    ...
    /*<j80025223><><DM response on snc for dlc greater than max number ><End>*/
    cmd_node = cm->dlc_db [dlc]->cmd_list;
...
int cmux_UE_cmd_handler (void *cmxlib, void *frm)
{
    ...
    /*j80025223: 16/10/2013: HQ issue : DM response if dlc0 is not established : Begin*/
    ...
    /*j80025223: 16/10/2013: HQ issue : DM response if dlc0 is not established : End*/
...
/* <j80025223><m2m-1014>, <to send the at+cld to send close down from target>, Begin*/
...
/*j80025223: 16/10/2013: m2m 1000 :snc db manipulation as per the snc command recieved : Begin*/
...
/*j80025223: 16/10/2013: m2m 1000 :snc db manipulation as per the snc command recieved : End*/
...
int cmux_UE_rxed_CLD_cmd (void *cmxlib, void *frm, unsigned char dlc)
{
    ...
    for (i = 1; i <= MAX_DLC_TGT; i++)
    {
        if (cm->dlc_db [i] != NULL)
        {
            /*j80025223: 16/10/2013: hq issue :cld recieved when other dlcs present : Begin*/
            ...
            /*j80025223: 16/10/2013: hq issue :cld recieved when other dlcs present : End*/
        }
    }
