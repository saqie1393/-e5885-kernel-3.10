...
cmux_check_com
Cmux_get_default_msc_params
Cmux_send_DISC
cmux_dlc_param_neg_validate
Cmux_cmuxlib_exit
Cmux_fetch_ppp_dlc_sncdb
Cmux_get_dlc_pending
Cmux_UE_send_muxcld         */
...
struct cmuxlib *Cmux_cmuxlib_init (enum CMUX_MODE mode, cmux_info_type *cmux_info)
{
    ...
    /*<j80025223><m2m-998><snc bd filling with deefautl values><Begin>*/
    Cmux_set_default_sncdb (cm);
    /*<j80025223><m2m-998><snc bd filling with deefautl values><End>*/
                        ...
                        unsigned short flush_len, unsigned short no_of_frames)
{
    ...
    if (control & CMUX_FLUSH_DATA)
    {
        /*<j80025223><m2m-1004><flow controll buffering on fcon fcoff or xon xoff><Begin>*/
        ...
        /*<j80025223><m2m-1004><flow controll buffering on fcon fcoff or xon xoff><End>*/
    }
    return rc;
} /* Cmux_send_dlc_data */
