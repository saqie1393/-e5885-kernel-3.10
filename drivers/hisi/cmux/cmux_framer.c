                                    ...
                                    struct cmuxlib *cm, struct frame *fr_temp)
{
    ...
    int test_len    = 0;
    int offset      = 0;
    /*juvin<m2m-595><length validation to avoid crash in case of wrong length value><24-march>*/
    ...
    do
    {
        ...
        switch (fr_temp->f_type)
        {
            case DLC_PN_CMD:
                ...
                /*juvin<m2m-595><length validation to avoid crash in case of wrong length value><24-march><Begin>*/
