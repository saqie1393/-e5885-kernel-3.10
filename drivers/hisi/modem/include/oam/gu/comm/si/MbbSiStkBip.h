...
typedef enum {
  BIP_ADDITIONAL_BEARERDES_TAG                             = 0x00, /* BEARER_DESCRIPTION_TAG */
  BIP_ADDITIONAL_BEARERDES_LENGTH                          = 0x01, /* bearerDesp Lengh */
  BIP_ADDITIONAL_BEARERDES_TYPE                            = 0x02, /* bearerDesp TYPE */
  BIP_ADDITIONAL_BUFFSIZE_TAG                              = 0x03, /* BUFFER_SIZE_TAG */
  BIP_ADDITIONAL_BUFFSIZE_LENGTH                           = 0x04, /* Buffer size Lengh */
  BIP_ADDITIONAL_BUFFSIZE_HIGH                             = 0x05, /* Buffer size Data high */
  BIP_ADDITIONAL_BUFFSIZE_LOW                              = 0x06, /* Buffer size Data low */
  BIP_ADDITIONAL_MAX                                       = 0xFF /* Max*/
}bip_additional_terminal_response_enum_type;
...
extern VOS_VOID BIP_STK_BufferEventProc(VOS_UINT8 ucSW1, VOS_UINT8 ucSW2);
/*Bip 5个主动命令处理声明*/
...
extern SI_UINT32 SI_STK_SendReqMsg(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId, SI_UINT32 MsgName,
                                    SI_UINT32 CmdType, SI_UINT32 DataLen, SI_UINT8 *pData);
extern VOS_UINT32 SI_STK_GetBipNV(NV_BIP_FEATURE_STRU *pstBipFeatureNV);

extern VOS_VOID  MN_PH_GetSysInfoRoamStatus(TAF_PH_SYSINFO_STRU *pstSysInfo);
extern VOS_UINT32 Sta_GetServiceStatus();
