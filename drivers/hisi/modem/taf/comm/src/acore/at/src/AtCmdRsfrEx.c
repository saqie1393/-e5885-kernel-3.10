...
struct app_flie_manage_type appfile_own_partion_name_tab[FILE_SUM] = 
{
    ...
    { "BITFLIP_SUMMARY.TAR.GZ", 527, "/mobilelog/bitflip_summary.tar.gz", FILE_BITFLIP_SUMMARY },
    ...
    { "NFBBINFO", REF_NUMBER, "/modem_log/nand_check_result.csv", FILE_BAD_BLOCK_CHECK }
};
...
struct app_flie_manage_type appfile_share_partion_name_tab[FILE_SUM] = 
{
    ...
    { "BITFLIP_SUMMARY.TAR.GZ", 527, "/online/bitflip_summary.tar.gz", FILE_BITFLIP_SUMMARY },
