...
#define HIFI_TCM_END_ADDR 0x7fe16000
#define HIFI_DATA_TCM_ADDR 0x8fe00000
#define HIFI_TOTAL_TCM_SIZE 0x16000
#define HIFI_TCM_BASE_ADDR (HI_HIFI2DMEM0_BASE_ADDR)
#define HIFI_PARAM_SOCP_REGBASE 0x91000000
#define HIFI_PARAM_IPC_REGBASE 0x9101E000
#define HIFI_PARAM_EDMAC_REGBASE 0x90003000
#define HIFI_PARAM_SLICER_REGBASE 0x20000000
#define HIFI_PARAM_Timer0_REGBASE 0x2001C020
#define HIFI_PARAM_Timer1_REGBASE 0x2001D020
#define HIFI_PARAM_BBP_TDS_REGBASE 0x81D00000
#define HIFI_PARAM_SYSCTRL_REGBAS 0x90000000
#ifdef __CMSIS_RTOS
...
{
    hifi_sc_set(0x900003e4, 18, 18, 0x1);
    hifi_sc_set(0x900003e4, 19, 19, 0x1);
    hifi_sc_set(0x900003e4, 20, 20, 0x1);
}
static inline void hifi_reset(void)
{
    hifi_sc_set(0x900003e0, 18, 18, 0x1);
    hifi_sc_set(0x900003e0, 19, 19, 0x1);
    hifi_sc_set(0x900003e0, 20, 20, 0x1);
}
#endif
#ifdef __cplusplus
}
