...
{
 soc_writel(0x3000,HI_AO_CRG_REG_BASE_ADDR+0x4);
 soc_writel(0x1400,HI_AO_CRG_REG_BASE_ADDR+0X45c);
 soc_writel(0x3000,HI_AO_CRG_REG_BASE_ADDR+0x0);
}
...
static inline void init_timer_stamp(void)
{
 ...
 soc_writel(0x1,0x90052020);
 soc_writel(0x101,0x90052000);
}
