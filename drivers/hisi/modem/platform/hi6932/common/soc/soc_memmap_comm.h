...
#define HI_DX_REG_BASE_ADDR (0x90004000)
#define HI_DX_REG_SIZE (SZ_4K)
...
#define HI_GPIO1_REGBASE_ADDR 0x9002B000
#define HI_GPIO1_REG_SIZE SZ_4K
#define HI_GPIO2_REGBASE_ADDR 0x9002C000
#define HI_GPIO2_REG_SIZE SZ_4K
#define HI_GPIO3_REGBASE_ADDR 0x9002D000
#define HI_GPIO3_REG_SIZE SZ_4K
#define HI_GPIO4_REGBASE_ADDR 0x9002E000
#define HI_GPIO4_REG_SIZE SZ_4K
#define HI_GPIO5_REGBASE_ADDR 0x9002F000
#define HI_GPIO5_REG_SIZE SZ_4K
#define HI_GPIO6_REGBASE_ADDR 0x90030000
#define HI_GPIO6_REG_SIZE SZ_4K
#define HI_GPIO7_REGBASE_ADDR 0x90031000
#define HI_GPIO7_REG_SIZE SZ_4K
#define HI_GPIO8_REGBASE_ADDR 0x90032000
#define HI_GPIO8_REG_SIZE SZ_4K
#define HI_GPIO9_REGBASE_ADDR 0x90033000
#define HI_GPIO9_REG_SIZE SZ_4K
#define HI_GPIO10_REGBASE_ADDR 0x90034000
#define HI_GPIO10_REG_SIZE SZ_4K
#define HI_GPIO11_REGBASE_ADDR 0x90035000
...
#define HI_BBP_LTEDRX_BASE_ADDR (0x81fd0000)
#define HI_BBP_TDSDRX_BASE_ADDR (0x81fd1400)
#define HI_BBP_COMM_ON_BASE_ADDR (0x81fd0000)
#define HI_GBBP_DRX_REG_BASE_ADDR (0x81fd0800)
#define HI_GBBP1_DRX_REG_BASE_ADDR (0x0)
#define HI_WBBP_DRX_REG_BASE_ADDR (0x81fd0000)
#define HI_BBP_CDMA_ON_BASE_ADDR (0x81fd0000)
#define HI_BBP_GLB_ON_BASE_ADDR (0x81fd0000)
#else
