...
set(CFG_PRODUCT_NAME "hi6932_E5885Ls-93a") 

set(CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME "Balong") 

set(CFG_PRODUCT_TYPE e5) 

set(CFG_BUILD_TYPE RELEASE) 

set(CFG_PRODUCT_VERSION V700R220C60B170) 

set(CFG_PRODUCT_VERSION_STR "V700R220C60B170") 

set(CFG_PRODUCT_FULL_VERSION_STR "Balong V700R220C60B170") 

set(CFG_PRODUCT_FILE_VERSION_STR "2.1.6.8") 

set(CFG_PRODUCT_DLOAD_SOFTWARE_VER "21.170.63.01.00") 

set(CFG_PRODUCT_CFG_DLOAD_KIND FW_WEBUI_ISO_LOGO) 

set(CFG_PRODUCT_CFG_DLOAD_ID E5885__0) 

set(CFG_PRODUCT_CFG_DLOAD_ID_DEBUG E5885) 

set(CFG_PRODUCT_CFG_DLOAD_NAME E5885Ls-93a) 

set(CFG_PRODUCT_DLOAD_DASHBOARD_VER UTPS_11.001.01.00.00) 

set(CFG_PRODUCT_DLOAD_WEBUI_VER WEBUI_21.100.00.00.00_NE5) 

set(CFG_PRODUCT_DLOAD_SIGN_KEY_NAME "P722s_E5785Lh-92a_PUBLIC.key") 

set(CFG_PRODUCT_DLOAD_SIGN_KEY_ID "/root/key/E5785Lh-92a/updateapp_key") 
...
set(CFG_OS_LINUX_PRODUCT_NAME hi6932_E5885Ls-93a_defconfig) 

set(CFG_TARGET_BALONG_PRODUCT hi6932_E5885Ls-93a) 
...
set(CFG_BSP_CONFIG_BOARD_E5 YES) 

set(CFG_BSP_CONFIG_BOARD_E5885Ls_93a YES) 
...
set(CFG_ENABLE_BUILD_AMON_SOC YES) 
...
set(CFG_CONFIG_FB_SPI_BALONG YES) 
...
set(CFG_CONFIG_FB_0_9_6_INCH_BALONG YES) 

set(CFG_CONFIG_PCIE_CFG YES) 

set(CFG_CONFIG_SFLASH NO) 

set(CFG_CONFIG_EMMC_BOOT NO) 
...
set(CFG_CONFIG_DDR_SECURITY YES) 
...
set(CFG_CONFIG_JUDGE_START_MODE YES) 
...
set(CFG_USB_DBG_PORTS_DISABLE NO) 
...
set(CFG_OS_PATH modem/config/product/hi6932_E5885Ls-93a/os) 
...
set(CFG_PRODUCT_CFG_PTABLE_VER_NAME "V7R220_E5") 
...
set(CFG_PRODUCT_CFG_FLASH_RECOVERY_LEN 0xF00000) 

set(CFG_PRODUCT_CFG_FLASH_MULTI_CARRIER_LEN 0x00000) 

set(CFG_FLASH_PTABLE_OFFSET						 0x1F800) 

set(CFG_PRODUCT_CFG_FLASH_MODEM_FW_LEN 0x01E00000) 
...
set(CFG_ONCHIP_FASTBOOT_ADDR 0xAE0FF000) 
...
set(CFG_DDR_SEC_MEM_ADDR 0xA0000000) 

set(CFG_DDR_SEC_MEM_SIZE       	 0x05E00000) 

set(CFG_DDR_UNSEC_MEM_ADDR 0xA5E00000) 

set(CFG_DDR_UNSEC_MEM_SIZE 0x0A200000) 
...
set(CFG_MBB_PTABLE_FASTBOOT_LEN (0x100000)) 

set(CFG_MBB_PTABLE_FASTBOOTBK_LEN (0x100000)) 

set(CFG_MBB_PTABLE_NVBACK_LEN (0x200000)) 

set(CFG_MBB_PTABLE_NVDEFAULT_LEN (0x200000)) 

set(CFG_MBB_PTABLE_NVIMAGE_LEN (0xA00000)) 

set(CFG_MBB_PTABLE_NVDLOAD_LEN (0x300000)) 

set(CFG_MBB_PTABLE_NVSYS_LEN (0x300000)) 

set(CFG_MBB_PTABLE_OEMINFO_LEN (0x140000)) 

set(CFG_MBB_PTABLE_KERNEL_LEN (0xA00000)) 

set(CFG_MBB_PTABLE_KERNELBK_LEN (0xA00000)) 

set(CFG_MBB_PTABLE_DTIMG_LEN (0x200000)) 

set(CFG_MBB_PTABLE_DTIMGBK_LEN (0x200000)) 

set(CFG_MBB_PTABLE_M3IMAGE_LEN (0x100000)) 

set(CFG_MBB_PTABLE_M3IMAGEBK_LEN (0x100000)) 

set(CFG_MBB_PTABLE_TEEOS_LEN (0x500000)) 

set(CFG_MBB_PTABLE_TEEOSBK_LEN (0x500000)) 

set(CFG_MBB_PTABLE_RESERVE2_LEN (0x000000)) 

set(CFG_MBB_PTABLE_USERDATA_LEN (0xC00000)) 

set(CFG_MBB_PTABLE_BBOU_LEN (0x3D80000)) 

set(CFG_MBB_PTABLE_MODEM_FW_LEN (0x1900000)) 

set(CFG_MBB_PTABLE_LOGO_LEN (0x100000)) 

set(CFG_MBB_PTABLE_HIFI_LEN (0x000000)) 
...
set(CFG_MBB_PTABLE_OM_LEN (0x800000)) 

set(CFG_MBB_PTABLE_WEBSDK_LEN (0x13C0000)) 

set(CFG_MBB_PTABLE_WEBUI_LEN (0x1700000)) 

set(CFG_MBB_PTABLE_SEC_STORAGE_LEN (0x0000000)) 

set(CFG_MBB_PTABLE_SYSTEM_LEN (0x1B00000)) 

set(CFG_MBB_PTABLE_MMC_LEN (0xC00000)) 
