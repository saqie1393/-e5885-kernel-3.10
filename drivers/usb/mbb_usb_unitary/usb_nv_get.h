...
#define HUAWEI_MANUFACTURER_STRING     "HUAWEI Technology"
#define HUAWEI_PRODUCT_STRING          "HUAWEI Mobile"
#define DAG_MANUFACTURER_STRING        "DAG"
#define DAG_PRODUCT_STRING_KOM1        "KOM1"
#define DAG_PRODUCT_STRING_KOM1_DEACT  "KOM1-DEACT"
#endif
...
{                                       /*|==================================|*/
    ...
    USB_NV_HUAWEI_SHELL_CMD = 50523,    /*端口加锁*/
...
typedef struct mbb_usb_nv_info
{
    ...
    USB_UINT                       ports_lock;       //USB_NV_HUAWEI_SHELL_CMD
    USB_UINT                       oeminfo_ports_lock;       //USB_NV_HUAWEI_SHELL_CMD
#endif
    ...
    nv_usb_ethering        usb_tethering_flag;    //USB_NV_USB_TETHERING_ID
...
USB_UINT get_ports_sec_lock(USB_VOID);

#ifdef BSP_CONFIG_BOARD_TELEMATIC
USB_UINT kernel_get_shlock_flag(unsigned int* lock);
#endif
/****************************************************************
