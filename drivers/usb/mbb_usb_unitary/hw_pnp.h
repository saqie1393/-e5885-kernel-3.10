...
extern void huawei_pm_set_usb_enum_status(void);
...
typedef enum
{
    ...
    TELEMATIC_BALONG_PID   = 0x15C3,  /* 车载模块产品PID               */
...
typedef enum _ncm_mbim_debug_mode
{
    ...
    ECM_DIAG_PCUI_DEBUG  = 4,
    ECM_DIAG_ADB_DEBUG  = 5,
    USB_NOPORT_MODE = 6,             /*usb setmode = 6*/
#endif
    SETMODE_FLAG_MAX,
