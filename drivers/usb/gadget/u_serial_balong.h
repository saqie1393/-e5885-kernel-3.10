...
#define MAX_U_SERIAL_PORTS	ACM_TTY_COUNT
#define USB_DEV_NAME_MAX    64
...
#ifdef USB_DBG_PORTS_DISABLE
#define ACM_CDEV_COUNT      2
#define ACM_TTY_COUNT       1
#define ACM_MDM_COUNT       1
#else
...
#define ACM_CDEV_USED_COUNT      (ACM_CDEV_COUNT-1)
#define ACM_TTY_USED_COUNT       (ACM_TTY_COUNT-1)
#define ACM_MDM_USED_COUNT       (ACM_MDM_COUNT-1)
