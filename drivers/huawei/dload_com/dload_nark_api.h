...
/* The logic boot flag for the next startup */
#define DLOAD_BOOT_A_FLAG_NUM           0x44424146          /* "DBAF" */
#define DLOAD_BOOT_B_FLAG_NUM           0x46424244          /* "FBBD" */
...
enum _MAIN_MODULE_MSG_ID
{
    ...
    GET_BOOT_FLAG = 12,             /* 获取双备份下次启动分区标志 */
    SET_BOOT_FLAG = 13,             /* 设置双备份下次启动分区标志 */
    SET_UPDATE_OVER_FLAG = 14,      /* 设置升级完成标志 */
    GET_PART_NAME_MAPPING_LEN = 15, /* 获取分区名映射关系表的长度 */
    GET_PART_NAME_MAPPING_TABLE = 16, /* 获取分区名映射关系表 */
};
