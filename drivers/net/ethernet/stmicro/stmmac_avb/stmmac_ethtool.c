				      ...
				      struct ethtool_cmd *cmd)
{
	...
	int rc;
	unsigned int u32_pcs;	//To remove BITWISE_OPERATOR coverity warning.

	u32_pcs = (unsigned int)priv->pcs;
	if ((u32_pcs & STMMAC_PCS_RGMII) || (u32_pcs & STMMAC_PCS_SGMII)) {
