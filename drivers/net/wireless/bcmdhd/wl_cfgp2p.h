...
struct p2p_info {
	...
	struct ether_addr_wl dev_addr;
	struct ether_addr_wl int_addr;
...
extern s32
wl_cfgp2p_ifchange(struct bcm_cfg80211 *cfg, struct ether_addr_wl *mac, u8 if_type, chanspec_t chspec);
...
extern void
wl_cfgp2p_generate_bss_mac(struct ether_addr_wl *primary_addr, struct ether_addr_wl *out_dev_addr,
            struct ether_addr_wl *out_int_addr);
