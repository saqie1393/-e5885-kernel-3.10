...
/* forward definition of ether_addr_wl structure used by some function prototypes */

struct ether_addr_wl;
...
/* ethernet address */
extern char *bcm_ether_ntoa(const struct ether_addr_wl *ea, char *buf);
extern int bcm_ether_atoe(const char *p, struct ether_addr_wl *ea);
...
#define ETHERP_TO_MACF(ea)	((struct ether_addr_wl *) (ea))->octet[0], \
							((struct ether_addr_wl *) (ea))->octet[1], \
							((struct ether_addr_wl *) (ea))->octet[2], \
							((struct ether_addr_wl *) (ea))->octet[3], \
							((struct ether_addr_wl *) (ea))->octet[4], \
							((struct ether_addr_wl *) (ea))->octet[5]
