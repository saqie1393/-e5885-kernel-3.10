...
typedef BWL_PRE_PACKED_STRUCT struct
{
	...
	struct ether_addr_wl	addr;	/* Station address (if applicable) */
...
typedef BWL_PRE_PACKED_STRUCT struct proxd_event_data {
	...
	struct ether_addr_wl peer_mac;	/* (e.g for tgt:initiator's */
...
typedef struct wl_psta_primary_intf_event {
	struct ether_addr_wl prim_ea;	/* primary intf ether addr */
