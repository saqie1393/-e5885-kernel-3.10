 ...
 */
BWL_PRE_PACKED_STRUCT struct	ether_addr_wl {
...
static const struct ether_addr_wl ether_bcast = {{255, 255, 255, 255, 255, 255}};
static const struct ether_addr_wl ether_null = {{0, 0, 0, 0, 0, 0}};
static const struct ether_addr_wl ether_ipv6_mcast = {{0x33, 0x33, 0x00, 0x00, 0x00, 0x01}};
