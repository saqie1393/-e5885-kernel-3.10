...
struct afx_hdl {
	...
	struct ether_addr_wl	tx_dst_addr;
...
struct bcm_cfg80211 {
	...
	bool nan_running;
	bool need_wait_afrx;
	struct ether_addr_wl last_roamed_addr;
};
...
extern s32 wl_cfg80211_get_p2p_dev_addr(struct net_device *net, struct ether_addr_wl *p2pdev_addr);
...
extern int wl_cfg80211_ether_atoe(const char *a, struct ether_addr_wl *n);
...
extern void get_primary_mac(struct bcm_cfg80211 *cfg, struct ether_addr_wl *mac);
