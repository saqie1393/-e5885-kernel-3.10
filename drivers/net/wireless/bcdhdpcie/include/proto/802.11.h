...
BWL_PRE_PACKED_STRUCT struct dot11_header {
	...
	struct ether_addr_bcm	a1;		/* address 1 */
	struct ether_addr_bcm	a2;		/* address 2 */
	struct ether_addr_bcm	a3;		/* address 3 */
	uint16			seq;		/* sequence control */
	struct ether_addr_bcm	a4;		/* address 4 */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_rts_frame {
	uint16			fc;		/* frame control */
	uint16			durid;		/* duration/ID */
	struct ether_addr_bcm	ra;		/* receiver address */
	struct ether_addr_bcm	ta;		/* transmitter address */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_ps_poll_frame {
	uint16			fc;		/* frame control */
	uint16			durid;		/* AID */
	struct ether_addr_bcm	bssid;		/* receiver address, STA in AP */
	struct ether_addr_bcm	ta;		/* transmitter address */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_cf_end_frame {
	...
	uint16			durid;		/* duration/ID */
	struct ether_addr_bcm	ra;		/* receiver address */
	struct ether_addr_bcm	bssid;		/* transmitter address, STA in AP */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_management_header {
	uint16			fc;		/* frame control */
	uint16			durid;		/* duration/ID */
	struct ether_addr_bcm	da;		/* receiver address */
	struct ether_addr_bcm	sa;		/* transmitter address */
	struct ether_addr_bcm	bssid;		/* BSS ID */
	uint16			seq;		/* sequence control */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_reassoc_req {
	uint16			capability;	/* capability information */
	uint16			listen;		/* listen interval */
	struct ether_addr_bcm	ap;		/* Current AP address */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct dot11_dls_req {
	...
	struct ether_addr_bcm	da;		/* destination address */
	struct ether_addr_bcm	sa;		/* source address */
...
BWL_PRE_PACKED_STRUCT struct member_of_brcm_prop_ie {
	...
	uchar oui[3];
	uint8	type;           /* type indicates what follows */
	struct ether_addr_bcm ea;   /* Device Primary MAC Adrress */
} BWL_POST_PACKED_STRUCT;
...
BWL_PRE_PACKED_STRUCT struct relmcast_brcm_prop_ie {
	...
	uint8 oui[3];
	uint8 type;           /* type indicates what follows */
	struct ether_addr_bcm ea;   /* The ack sender's MAC Adrress */
	struct ether_addr_bcm mcast_ea;  /* The multicast MAC address */
...
BWL_PRE_PACKED_STRUCT struct link_id_ie {
	...
	uint8 len;
	struct ether_addr_bcm	bssid;
	struct ether_addr_bcm	tdls_init_mac;
	struct ether_addr_bcm	tdls_resp_mac;
} BWL_POST_PACKED_STRUCT;
