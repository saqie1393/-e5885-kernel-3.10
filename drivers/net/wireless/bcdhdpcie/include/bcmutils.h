...
/* forward definition of ether_addr_bcm structure used by some function prototypes */

struct ether_addr_bcm;
...
/* ethernet address */
extern char *bcm_ether_ntoa(const struct ether_addr_bcm *ea, char *buf);
extern int bcm_ether_atoe(const char *p, struct ether_addr_bcm *ea);
...
#define ETHERP_TO_MACF(ea)	((struct ether_addr_bcm *) (ea))->octet[0], \
							((struct ether_addr_bcm *) (ea))->octet[1], \
							((struct ether_addr_bcm *) (ea))->octet[2], \
							((struct ether_addr_bcm *) (ea))->octet[3], \
							((struct ether_addr_bcm *) (ea))->octet[4], \
							((struct ether_addr_bcm *) (ea))->octet[5]
