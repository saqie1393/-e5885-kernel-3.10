...
struct afx_hdl {
	...
	struct ether_addr_bcm	tx_dst_addr;
...
struct bcm_cfg80211 {
	...
	u32 rmc_event_seq;
#ifdef WLAIBSS_MCHAN
	struct ether_addr_bcm ibss_if_addr;
...
#endif /* QOS_MAP_SET */
	struct ether_addr_bcm last_roamed_addr;
#ifdef DHD_LOSSLESS_ROAMING
...
extern s32 wl_cfg80211_get_p2p_dev_addr(struct net_device *net, struct ether_addr_bcm *p2pdev_addr);
...
extern int wl_cfg80211_ether_atoe(const char *a, struct ether_addr_bcm *n);
...
extern void get_primary_mac(struct bcm_cfg80211 *cfg, struct ether_addr_bcm *mac);
