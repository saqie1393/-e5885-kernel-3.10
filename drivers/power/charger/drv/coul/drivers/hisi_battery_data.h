...
typedef struct coul_battery_data_diff {
    unsigned int hardware_version_id;
    unsigned int support_batt_num;
    struct hisi_smartstar_coul_battery_data *coul_batt_data_array;
}coul_battery_data_diff_st;
