...
#define SPI0_CLK_EN        (g_spi_virtual_addr.hi_sysctrl_base_addr_virt + HI_PD_CRG_CLKEN1_OFFSET)
#define SPI0_CLK_DIS        (g_spi_virtual_addr.hi_sysctrl_base_addr_virt + HI_PD_CRG_CLKDIS1_OFFSET)
#define SPI0_MODE_THREE        (g_spi_virtual_addr.hi_sysctrl_base_addr_virt + 0x040C)
