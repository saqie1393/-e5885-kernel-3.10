...
#define DEVICE_UNREADY 0 /*0表示device进程未启动*/
#define DEVICE_READY 1   /*1表示device进程已经启动*/
static int device_flag = DEVICE_UNREADY;
/*************************************************************************
* 函数名     :get_device_flag
* 功能描述   :读取当前device_flag状态,device_flag标识device进程是否启动
* 输入参数   :
* 输出参数   :
* 返回值     :
**************************************************************************/
